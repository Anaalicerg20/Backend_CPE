...
rotas.delete('/usuarios/:id', verificarUsuario, UsuarioValidator.destroy, UsuarioController.delete);
rotas.put('/usuarios/:id', verificarUsuario, UsuarioValidator.update, UsuarioController.update);

//sessoes
rotas.post('/sessoes', verificarUsuario, SessoesValidator.create, SessoesController.create);
rotas.get('/sessoes', SessoesController.read);
rotas.delete('/sessoes/:id_usuario', verificarUsuario,  SessoesValidator.destroy, SessoesController.delete);
